            ...
            <div className="max-w-md mx-auto glass-card rounded-2xl p-8 border border-dourado/20 text-center">
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 bg-white text-black font-sans text-xs font-bold py-2.5 px-5 rounded-md hover:bg-neutral-200 transition-all shadow-md cursor-pointer border border-neutral-200"
                >
